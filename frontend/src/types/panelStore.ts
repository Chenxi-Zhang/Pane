...
export interface PanelStore {
  ...
  getPanelActivityStatus: (panelId: string) => 'active' | 'idle' | 'unviewed' | 'waiting_for_input';
  getSessionActivityStatus: (sessionId: string) => 'active' | 'idle' | 'unviewed' | 'waiting_for_input';
}
